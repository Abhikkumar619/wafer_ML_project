...
from src.components.constant import *
from src.exception import CustomException
from src.logger import logging
from src.utils import evaluate_models, load_object, save_object, uplod_file
    ...
    def initiate_model_trainer(self, train_array, test_array, preprocessor_path):
        try:
            ...
            models={
                ...
                "Gradient Booting" : GradientBoostingClassifier(),
            ...
            custom_model=CustomModel(
                ...
                trained_model_objext=best_model,
            )
            logging.info(
