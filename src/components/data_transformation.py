...
from imblearn.combine import SMOTETomek   # Handling imbalance dataset
...
class DataTransformationConfig:
    preprocessor_obj_file_path=os.path.join("artifacts", "preproecessor.pkl")
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            input_feature_test_final, target_feature_test_final=smt.fit_resample(
                transformed_input_test_feature, target_feature_train_df
            )
            
            train_arr=np.c_[input_feature_train_final, np.array(target_feature_test_df)]
